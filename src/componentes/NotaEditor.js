...
export default function NotaEditor({ mostraNotas, notaSelecionada, setNotaSelecionada }) {
  ...
  return (
    <>
      ...
      >
        <TouchableOpacity style={estilos.container} onPress={() => { limpaModal() }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              <View style={estilos.modal}>
                ...
                <View style={estilos.modalBotoes}>
                  ...
                  <TouchableOpacity style={estilos.modalBotaoSalvar} onPress={notaParaAtualizar ? modificarNota : salvarNota}>
